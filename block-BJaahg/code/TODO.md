...
console.log(name); // undefined, function is not returning any value.
```
...
console.log(name); // Arya Stark, var is functional scoped so we can access the value.
```
...
console.log(i); // 20  because var is functional scoped.
